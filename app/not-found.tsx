      ...
      <div className="relative z-10 bg-white/80 backdrop-blur-lg shadow-2xl rounded-2xl max-w-lg w-full p-8 border border-white/20 text-center">
        ...
        <div className="space-y-4 text-gray-600 mb-8">
          <p className="text-lg font-bold">
            This application is currently in “Hibernation Mode”… our devs went
            unpaid and the coffee ran out. ☕💤
          </p>
          <div className="flex flex-col items-center justify-center mt-6 space-y-2 relative">
            ...
            >
              ...
              />
              <path
                d="M46 28h4a4 4 0 0 1 0 8h-4"
                stroke="#8B5E3C"
                strokeWidth="2"
              />
              <path
                d="M28 20c0-4 8-4 8 0"
                stroke="#F3E5AB"
                strokeWidth="2"
                strokeLinecap="round"
              />
            ...
            <div className="relative bg-white/90 backdrop-blur-md p-3 rounded-xl shadow-lg text-center text-gray-800 font-medium animate-pulse">
              ...
              <br />
              but food, shelter & coffee are kinda important 😅
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-yellow-700">
                  <span className="font-medium">System Note:</span> The "Un-blur
                  Website" feature is automatically triggered upon receipt of
                  payment.
                </p>
              </div>
            </div>
        ...
        <p className="mt-8 text-xs text-gray-400">
          ID: MISSING_INVOICE_#001 • Timestamp:{" "}
